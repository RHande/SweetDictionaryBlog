    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 10, 17, 20, 3, 42, 913, DateTimeKind.Local).AddTicks(8580), "Yazılım", null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "CreatedTime", "Email", "FirstName", "LastName", "Password", "UpdatedTime", "Username" },
                values: new object[] { 1L, new DateTime(2024, 10, 17, 20, 3, 42, 915, DateTimeKind.Local).AddTicks(3450), "ismail@gmail.com", "İsmail", "Yılmaz", "123456", null, "admin" });
